...
#
# 2025/08/27 ImageMaskDatasetGenerator.py
...
class ImageMaskDatasetGenerator:
  ...
  def generate(self, images_dir, masks_dir, 
...
if __name__ == "__main__":
  try:
    ...
    output_dir        = "./TNBC-PNG-master/"
    output_images_dir = "./TNBC-PNG-master/images/"
    output_masks_dir  = "./TNBC-PNG-master/masks/"
    ...
    # Create png image and mask files from nii.gz files under imagesTr and labelsTr.
